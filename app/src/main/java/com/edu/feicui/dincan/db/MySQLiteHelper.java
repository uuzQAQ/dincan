...
public class MySQLiteHelper extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase sqLiteDatabase) {
        ...
        sqLiteDatabase.execSQL("create table if not exists temp_orders(_id integer primary key autoIncrement,table_num text,dish_id text,count text default 1,remark text default '')");
        sqLiteDatabase.execSQL("create table if not exists orders(_id integer primary key autoIncrement,order_id text,table_num text,checkout boolean default 0)");
    }
